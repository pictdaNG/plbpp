              ...
              <div className="uk-child-width-1-2@s uk-child-width-1-3@m uk-grid-small" data-uk-grid>
                <div>
                  <div className="uk-card uk-card-default uk-flex uk-flex-center uk-flex-middle">
                    <img src="./assets/img/gallery/news1.jpg" alt="news1"/>
                  </div>
                </div>
                <div>
                  <div className="uk-card uk-card-default uk-flex uk-flex-center uk-flex-middle">
                    <img src="./assets/img/gallery/news2.jpg" alt="news2"/>
                  </div>
                </div>
                <div>
                  <div className="uk-card uk-card-default uk-flex uk-flex-center uk-flex-middle">
                    <img src="./assets/img/gallery/news3.jpg" alt="news3"/>
                  </div>
                </div>
                <div>
                  <div className="uk-card uk-card-default uk-flex uk-flex-center uk-flex-middle">
                    <img src="./assets/img/gallery/news4.jpg" alt="news4"/>
                  </div>
                </div>
                <div>
                  <div className="uk-card uk-card-default uk-flex uk-flex-center uk-flex-middle">
                    <img src="./assets/img/gallery/news5.jpg" alt="news"/>
                  </div>
                </div>
                <div>
                  <div className="uk-card uk-card-default uk-flex uk-flex-center uk-flex-middle">
                    <img src="./assets/img/gallery/news6.jpg" alt="news"/>
                  </div>
                </div>
                <div>
                  <div className="uk-card uk-card-default uk-flex uk-flex-center uk-flex-middle">
                    <img src="./assets/img/gallery/news7.jpg" alt="news"/>
                  </div>
                </div>
                <div>
                  <div className="uk-card uk-card-default uk-flex uk-flex-center uk-flex-middle">
                    <img src="./assets/img/gallery/news8.jpg" alt="news"/>
                  </div>
                </div>
                <div>
                  <div className="uk-card uk-card-default uk-flex uk-flex-center uk-flex-middle">
                    <img src="./assets/img/gallery/news9.jpg" alt="news"/>
                  </div>
                </div>
